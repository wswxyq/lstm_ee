"""Plot binned statistics plots of energy resolution vs RecoE"""

import argparse

from lstm_ee.presets         import PRESETS_EVAL
from lstm_ee.plot.hairy_mean import plot_hairy_mean_binstat, plot_hairy_mean_binstat_xreco
